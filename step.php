...
<html>
<head>
<title>Mi Cuenta | Home :: Monteverde - Servicios Ambientales y Forestales</title>
...
<body class="sticky-header left-side-collapsed" > <!-- //  onload="initMap()" && class="" -->
	<script>
		...
		function testAPI() {
			...
			jQuery(".monteverde-username").text(Mv.userData().username);
		}
	</script>
    <section>
    <!-- left side start-->
			...
			<div class="menu-right">
				<div class="user-panel-top">  	
						...
						<ul>
							<li class="dropdown profile_details_drop">
								<a href="#/" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p class="monteverde-username">username</p>
											<p>
												<span id="status">
													Administrator
												</span>
								...
								<ul class="dropdown-menu drp-mnu">
									...
									-->
									<li> <a href="javascript: Mv.logout(true);"><i class="fa fa-sign-out"></i> Salir</a> </li>
								</ul>
							</li>
							<div class="clearfix"> </div>
						</ul>
					...
					<div class="social_icons">
						<div class="col-sm-2 social_icons-left">
							<a target="_blank" href="https://www.facebook.com/monteverdeforestalyambiental/" class="yui">
								<i class="fa fa-facebook i1"></i>
								<!-- // <span>300<sup>+</sup> Likes</span> -->
							</a>
						</div>
						<div class="col-sm-2 social_icons-left pinterest">
							<!-- // <a href="#/"><i class="fa fa-google-plus i1"></i><span>500<sup>+</sup> Shares</span></a> -->
						</div>
						<div class="col-sm-2 social_icons-left twi">
							<a href="#/">
								<i class="fa fa-twitter i1"></i>
								<!-- // <span>500<sup>+</sup> Tweets</span> -->
							</a>
						</div>
						<div class="clearfix"> </div>
					</div>            	
